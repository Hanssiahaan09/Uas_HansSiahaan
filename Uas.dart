...
class App04 extends StatelessWidget {
  Widget build(BuildContext context) {
    return MaterialApp(
      routes: {
        "Data": (context) => HansSiahaanDataTable(),
      ...
      home: Scaffold(
        appBar: AppBar(
          title: Text('UAS-Hans Batara Yudha Siahaan (6SIA6)'),
        ),
        body: LoginPage(),
      ),
    );
...
class HansSiahaanDataTable extends StatefulWidget {
  _HansSiahaanDataTableState createState() => _HansSiahaanDataTableState();
}

class _HansSiahaanDataTableState extends State <HansSiahaan DataTable> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Hans Batara Yudha Siahaan- 6SIA6'),
      ),
...
class DataMahasiswa {
  ...
  static List<DataMahasiswa> getDataBarang() {
    return <DataMahasiswa>[
      DataMahasiswa(
          id: "Nama", namabarang: "Hans Batara Yudha Siahaan", ),
      DataMahasiswa(),
...
class _AritmatikaState extends State<Aritmatika> {
  ...
  onHitung() {
    setState(() {
      var  jumlah= int.parse(Jumlah.text) * int.parse(Harga.text);
      hasil = "$jumlah";
    });
  }
